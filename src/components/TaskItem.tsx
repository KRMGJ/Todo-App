...
export function TaskItem({ task, onChangeStatus, onRemove }: TaskItemProps) {
    return (
        <div className="w-full rounded-lg border border-slate-200 bg-white px-4 py-3 shadow-sm flex flex-col gap-3 dark:bg-slate-900 dark:border-slate-700">
            <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                    <p className="font-medium text-slate-900 dark:text-slate-50 wrap-break-word">
                        {task.title}
                    </p>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className="rounded-md border border-red-300 bg-red-50 px-2 py-1 text-sm font-medium text-red-700 hover:bg-red-100
                                dark:bg-red-900/30 dark:border-red-700 dark:text-red-200 dark:hover:bg-red-900/50">
                        삭제
                    </button>
                </div>
            </div>
